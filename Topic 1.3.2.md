...
# Topic 1.3: The Power of Geographic Data (Part 2: Applications & Data Grouping)
### Case Study: The London Underground Map

> **Relative Location vs. Absolute Accuracy**  
> Designed by Harry Beck in 1933, the London Subway map intentionally sacrifices geographic distance and route curves to create a simplified topological map.

-   **Key Map Adjustments:**
    -   Replaced winding transit routes with straight lines.
    -   Expanded station spacing in crowded city centers and condensed spacing in outer suburbs.
-   **Why It Works:** Commuters prioritize transfer points and line connections (relative location) over absolute ground distance.
