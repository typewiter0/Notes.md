...
# Topic 1.6: Scales of Analysis (Part 2: Applications & Avoiding False Conclusions)
...
> **False Conclusion:** An inaccurate generalization or inference drawn from data aggregated at an inappropriate scale.

-   **Example:** Using broad U.S. national data to claim that life expectancy in a specific local city is rising.
-   **Scale Differences in Data Interpretation:**
    -   From 1940–1950, global average life expectancy was increasing.
    -   During the same decade, Japan’s national life expectancy dropped sharply due to WWII.
    -   _Both conclusions are true simultaneously because the scale of analysis differs._

#### Questions to Evaluate Data Validity:

1.  Is the conclusion supported by the scale of the data?
2.  Is the scale of the conclusion appropriate for the scale of the data?
3.  Is the data accurate and trustworthy?
4.  Is there other data that could support or refute the conclusion?
