...
# Topic 1.1: Introduction to Maps (Part 2: Distributions & Projections)
...
Directions are accurate; grid lines meet at right angles[cite: 1].

Land masses near poles appear severely enlarged (e.g., Greenland appears same size as Africa)[cite: 1].

**Peters**

Spatial distribution / area[cite: 1]

True size of land masses is accurate[cite: 1].

Shapes are heavily distorted, especially near the poles[cite: 1].

**Conic**

General midlatitude use[cite: 1]

Lines of longitude converge; size and shape are balanced and close to reality[cite: 1].
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxMTY3NzEyNV19
-->